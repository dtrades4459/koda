    ...
    return (
      <div style={{ padding: "28px 0 8px", borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}` }}>
        ...
        <p style={{ fontSize: "14px", color: C.text2, lineHeight: 1.65, marginBottom: "20px", fontFamily: BODY }}>
          If you added a recovery email at signup, your reset link is on its way — check your inbox (and spam folder). If you didn't add one, reply to this page and we'll help you out manually.
        </p>
